...
public class FactorialTest {
    ...
    // FACTORIAL MENGGUNAKAN PERULANGAN
    ...
    @Test
    void testFactorialPerulangan(){
        Assertions.assertEquals(1, factorialPerulangan(0));
        Assertions.assertEquals(1, factorialPerulangan(1));
        Assertions.assertEquals(2, factorialPerulangan(2));
        Assertions.assertEquals(6, factorialPerulangan(3));
        Assertions.assertEquals(24, factorialPerulangan(4));
        Assertions.assertEquals(120, factorialPerulangan(5));
    }
